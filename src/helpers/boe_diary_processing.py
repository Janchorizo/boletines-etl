"""Utility methods for BOE diary processing."""
...
def get_sections(tree: et._Element) -> Generator:
    """Get sections' node and number in a BOE diary."""
    sections = (
...
def get_departments_per_section(sections: Iterable) -> Generator:
    """Get departments' node and name in a BOE diary section."""
    departments = (
...
def get_items_per_department(departments: Iterable) -> Generator:
    """Get all items (including epigraphs) in a BOE diary department."""
    items = (
        (section_number, department_name, item)
...
def get_item_details(section_number: str, department_name: str, node: et._Element) -> Dict:
...
def get_details_per_item(items: Iterable) -> Generator:
    """Get the details for each provided BOE diary item."""
